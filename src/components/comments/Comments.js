...
const Comments = () => {
  ...
  // using useEffect to send a request to fetch comments when this component loads.
  useEffect(() => {
    sendRequest(quoteId);
  }, [sendRequest, quoteId]);
  ...
  const addedCommentHandler = useCallback(() => {
    // whenever a comment was added, the comments should be updated in the comments list.
    sendRequest(quoteId)
  }, [sendRequest, quoteId]);
